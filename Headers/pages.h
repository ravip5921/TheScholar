...
namespace Home{
    ...
    Color usernameBoxC(0.1, 0.9, 0.43);

    Coord_Rect usernameBox(-2, -6, 3, 1.2);
    Coord_Rect logoutButtonD(6.5, 8, 3, 1.5);
    Coord_Rect usernameD(5,5,4,1.5);

//    glDrawP(-2.0, -6.0, 3.0, 1.2);

    Text usernameHome(3, 8.5, userNameC, "Username" , GLUT_BITMAP_HELVETICA_18);
    ...
    void addHomeComponents(GUIPage *_homePage)
    {
        ...
        _homePage->addComponent(&usernameHome);
       // _homePage->addComponent(&glDrawP);
    }
}//namespace Home
